...
public enum CardType {
	...
	private CardType(String cardDisplayName, CardCategory cardCategory, // 
					 ...
					 int shieldCount, int hornCount, // only when cardCategory==War
	...
	// for War card
	private CardType(String cardDisplayName, int shieldCount, int hornCount, String imageResource) {
		this(cardDisplayName, CardCategory.WarCard, null, null, shieldCount, hornCount, 0, false, imageResource);
	}
	// for Politic card
